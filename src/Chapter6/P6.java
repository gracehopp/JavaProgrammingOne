...
public class P6 {
    ...
    /**
     * Conversion more accurately approximates the end total given by the user
     * using the rate the currency runs and the deductable amount charged.
     *
     * @param dollarAmt dollarAmt is the amount in dollars given in exchange for
     * foreign currency
     * @param deductable deductable is the deductable charged on the dollar
     * amount
     * @param x x is the rate amount of the foreign currency ratio to one dollar
     * @return returns the amount of currency the user can buy
     */
